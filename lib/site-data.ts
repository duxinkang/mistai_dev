  ...
  zh: {
    ...
    contact: {
      ...
      messages: {
        ...
        submitting: "提交中...",
        submit: "提交",
        success: "提交成功，内容已保存在当前浏览器中。若要正式收集线索，请接入真实表单服务。",
        failed: "提交失败，请稍后重试",
      },
    },
    footer: {
  ...
  en: {
    ...
    contact: {
      ...
      messages: {
        ...
        submit: "Submit",
        success: "Submitted successfully. Your message has been saved in this browser. Connect a real form backend if you want production lead capture.",
